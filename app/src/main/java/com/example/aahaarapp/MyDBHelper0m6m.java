...
public class MyDBHelper0m6m extends SQLiteOpenHelper {
    ...
    public void updateColumns(String id, String value1, String value2, String value3,String value4,String value5,String value6,String value7,String item) {
        SQLiteDatabase db = this.getWritableDatabase();
        String qurery = "UPDATE " + TABLE_NAME_Lac + " SET " + Nutritional + " = '" + value1 + "', " + Energy + " = '" + value2 + "', " + Protein + " = '" + value3 + "', " + Fat + " = '" + value4 + "', " + Food_Solid + " = '" + value5 + "', " + Hemoglobin + " = '" + value6 + "', " + Health_Service + " = '" + value7 + "', " + vaccination + " = '" + item + "' WHERE " + Mobile_number + " = '" + id + "'";
        db.execSQL(qurery);
